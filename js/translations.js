...
const TRANSLATIONS = {
  en: {
    ...
    hero_subtitle:
      "Building production-grade web products and machine learning systems. Currently leading AI at TradeSpark, an Argentine capital-markets fintech.",
    ...
    edu_current_subtitle: "TradeSpark · Full-time",
    edu_current_meta: "Tandil, Buenos Aires Province, Argentina · Hybrid",
    edu_current_date: "APR 2026 — PRESENT",
    ...
    edu2_subtitle: "UNICEN · Graduate",
    edu2_desc:
      "5-year licentiate program equivalent to an MSc, completed with a 8.93/10 GPA. Rigorous coursework in linear algebra, calculus, discrete math, data structures, and algorithms.",

    edu3_title: "Teaching Assistant",
    edu3_subtitle: "UNICEN | Faculty of Exact Sciences",
    edu3_desc:
    ...
    section_about: "About",
    about_prose:
      "I'm a Systems Engineer, graduated from UNCPBA (Argentina). I build web products and work on AI applied to financial markets.\n\nAt TradeSpark, I lead and build the AI area as its main engineer. My work is building tools to solve real problems that traders and financial analysts face day to day, bringing in AI where it's genuinely needed and worthwhile.",
  ...
  es: {
    ...
    hero_subtitle:
      "Construyo productos web y sistemas de machine learning para producción. Actualmente lidero el área de IA en TradeSpark, una fintech argentina de mercados de capitales.",
    ...
    proj2_desc:
      "Plataforma web para Centros de Educación Agraria. Sitios públicos + panel de administración centralizado para la gestión de capacitaciones, inscripciones y exportación de datos a organismos gubernamentales.",
    ...
    proj5_title: "Videojuegos",
    proj5_tag: "Desarrollo de Videojuegos",
    proj5_desc:
      "Juegos móviles publicados en Google Play: Donut Tunnel, Neon Hover, Planet Dance. Generación procedural, simulación orbital y diseño de jugabilidad.",
    ...
    edu_current_subtitle: "TradeSpark · Jornada completa",
    edu_current_meta: "Tandil, Provincia de Buenos Aires, Argentina · Híbrido",
    edu_current_date: "ABR 2026 — ACTUALIDAD",

    edu1_title: "Pasante de Ingeniería en Machine Learning",
    edu1_desc:
      "Diseñé e implementé un pipeline de machine learning para predecir retornos bursátiles, integrando preprocesamiento de datos, ingeniería de características y evaluación de modelos. Apliqué IA y un enfoque basado en datos a estrategias de trading algorítmico.",

    edu2_title: "Ingeniería en Sistemas",
    edu2_subtitle: "UNICEN · Graduado",
    edu2_desc:
      "Carrera de grado de 5 años (equivalente a una maestría), finalizada con un promedio de 8,93/10. Formación sólida en álgebra lineal, cálculo, matemática discreta, estructuras de datos, algoritmos, arquitectura de computadoras, sistemas operativos y bases de datos.",

    edu3_title: "Ayudante de Cátedra",
    edu3_subtitle: "UNICEN | Facultad de Ciencias Exactas",
    edu3_desc:
      'Ayudante en "Introducción a los Sistemas Informáticos", "Ciencias de la Computación I" y "Arquitectura de Computadoras II". A cargo de las clases prácticas, la corrección de parciales y la explicación de los conceptos fundamentales.',

    edu4_title: "Formación Online — Web, IA y Matemáticas",
    edu4_desc:
      "Más de 35 cursos de desarrollo frontend, machine learning y fundamentos matemáticos. En Platzi formé mi intuición como ingeniero antes de la universidad, y sigo aprendiendo ahí cada vez que la curiosidad le gana al plan de estudios.",
    edu4_link: "Ver Perfil ↗",

    /* ── About section ── */
    section_about: "Sobre mí",
    about_prose:
      "Soy Ingeniero en Sistemas, recibido en la UNCPBA (Argentina). Desarrollo productos web y trabajo en IA aplicada a los mercados financieros.\n\nEn TradeSpark, lidero y construyo el área de IA como ingeniero principal. Mi trabajo es construir herramientas para resolver problemas reales que los traders y analistas financieros enfrentan en su día a día, incorporando IA donde es realmente necesaria y conveniente.",
    ...
    contact_text:
      "Si estás trabajando en algo que vive en el cruce entre la ingeniería y el impacto real —ya sea un producto, un problema de investigación o algo intermedio—, me encantaría que me lo cuentes.",
    ...
    ceapp_context_p2:
      "Antes de CEApp, la gestión era completamente manual —papel, planillas y correos— sin visibilidad para el público ni un flujo claro para los administradores.",
    ...
    games_donut_body:
      "Mi lanzamiento más reciente. Colorido, (extrañamente) entretenido y peligrosamente adictivo. Sos una dona. El túnel está hecho de donas. Tenés que sobrevivir. No sé cómo explicarlo mejor: vas a tener que probarlo.",
    games_play_link_gp: "Disponible gratis en Google Play Store",
    ...
    games_try_body:
      "Hecho en menos de 12 horas. Ya no está disponible — misma historia que A-void. Pero lo rápido que salió me enseñó algo: las restricciones son una ventaja, no un obstáculo.",
    ...
    sem_who_title: "¿Qué es Semillero?",
    sem_context_p1:
    ...
    aut_overview_p1:
      "Los autómatas finitos son un concepto fundamental de la teoría de la computación, pero los diagramas de los libros son estáticos y difíciles de razonar. My Automata les da vida: arrastrá nodos, dibujá transiciones y comprobá al instante si una cadena de entrada es aceptada o rechazada.",
    aut_overview_p2:
